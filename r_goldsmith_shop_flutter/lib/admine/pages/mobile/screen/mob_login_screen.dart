...
import 'package:r_goldsmith_shop_flutter/admine/controller/admine_auth_controller.dart';
import 'package:r_goldsmith_shop_flutter/admine/route/routes.dart';

import '../../../../user/controller/auth_controller.dart';

class MobLoginScreen extends StatefulWidget {
  const MobLoginScreen({super.key});

  @override
  State<MobLoginScreen> createState() => _MobLoginScreenState();
}

class _MobLoginScreenState extends State<MobLoginScreen> {
